						...
						<div className="w-full rounded-xl bg-white p-8 drop-shadow-xl">
							<div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-6">
								<div className="text-md w-24 text-center">
									<span className="font-bold text-black">10:30</span>
									<br />
									<span className="text-slate-500">11:30</span>
								</div>
								<img
									src={img}
								...
								<div className="flex flex-col">
									<div>
										<span className="inline text-xl font-bold">{title}</span>
										{", "}
									...
									<div>
										<span className="text-lg">{stars}</span> 3.1, Attraction
									</div>
				...
				return (
					<div className="w-full max-w-4xl">
						...
						<div className="ml-10 flex flex-row items-center space-x-4">
							<div className="rounded-full bg-green-200 p-3 drop-shadow-lg">
								<PaperAirplaneIcon className="w-6 rotate-90 transform" />
							</div>
							<div>
								travel from {fromPos} to {toPos}
							</div>
						</div>
						<div className="ml-16 h-3 w-0.5 bg-slate-400" />
					</div>
